...
const (
	// ThemeMetaFile is default theme's meta filename
	ThemeMetaFile string = "theme.toml"
)
...
func (th *Theme) parseMeta() {
	file := path.Join(th.dir, ThemeMetaFile)
	th.metaFile = file
	th.Meta, th.metaError = NewMetaFromFile(file)
}
